  ...
  return (
    <div className="relative w-full h-full flex items-center justify-center animate-fade-in text-retro-ink overflow-hidden">
      ...
      <div className={`
          ...
          ${viewMode === ViewMode.CONFIG ? 'w-[50vmin] h-[50vmin] opacity-20' : 'w-[70vmin] h-[70vmin] opacity-100'}
      ...
      <div className={`
          absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 transition-all duration-1000 ease-[cubic-bezier(0.25,1,0.5,1)]
          ${viewMode === ViewMode.CONFIG ? 'w-[40vmin] h-[40vmin] opacity-20' : 'w-[60vmin] h-[60vmin] opacity-80'}
      ...
      <div className={`
        relative z-10 flex flex-col items-center transition-all duration-1000 ease-[cubic-bezier(0.25,1,0.5,1)] origin-[30%_50%]
